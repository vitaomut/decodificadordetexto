function criptografa() {
    ...
    var criptagrafar = document.querySelector("#criptografar");

    criptagrafar.addEventListener("click", function (event) {
        event.preventDefault();
        const textoCriptografado = criptografaTexto(campoTexto.value);

        var campoVazio = document.querySelector(".sem-mensagem");
...
function descriptografa() {
    var campoTexto = document.getElementById("texto-principal");
    var criptagrafar = document.querySelector("#descriptografar");
